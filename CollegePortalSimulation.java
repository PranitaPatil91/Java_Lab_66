...
public class CollegePortalSimulation {
    public static void main(String[] args) {
        Person student = new Student("Pranita", "S101", "pranita123", "pass123");
        Person faculty = new Faculty("Abhijit Mophare", "F201", "mophare", "admin123");

        Login sLogin = (Login) student;
        if (sLogin.login("pranita123", "pass123")) {
        ...
        if (fLogin.login("mophare", "admin123")) {
